...
public class AdvancedWebView extends NestedScrollWebView {
    ...
    public static boolean handleDownload(final Context context, final String fromUrl, final String toFilename) {
        ...
        if (fromUrl.startsWith("blob")) {
            Toast.makeText(context, "Blob downloads currently are not supported in WebView", Toast.LENGTH_SHORT).show();
            return true;
        }
