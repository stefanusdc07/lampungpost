...
public class PurchaseHelper {
    ...
    void handlePurchases(List<Purchase>  purchases) {
        for(Purchase purchase:purchases) {
            ...
            if (context.getString(R.string.product_id).equals(purchase.getSku()) && purchase.getPurchaseState() == Purchase.PurchaseState.PURCHASED)
            {
            ...
            else if(context.getString(R.string.product_id).equals(purchase.getSku()) && purchase.getPurchaseState() == Purchase.PurchaseState.PENDING)
            {
                Toast.makeText(context,
                        context.getString(R.string.settings_purchase_pending), Toast.LENGTH_SHORT).show();
            }
            //if purchase is unknown
            else if(context.getString(R.string.product_id).equals(purchase.getSku()) && purchase.getPurchaseState() == Purchase.PurchaseState.UNSPECIFIED_STATE)
            {
                savePurchaseValueToPref(false);
            }
        }
